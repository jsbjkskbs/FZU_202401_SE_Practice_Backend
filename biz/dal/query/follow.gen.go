...
func newFollow(db *gorm.DB, opts ...gen.DOOption) follow {
	...
	_follow.FollowedID = field.NewInt64(tableName, "followed_id")
	_follow.FollowerID = field.NewInt64(tableName, "follower_id")
	_follow.CreatedAt = field.NewInt64(tableName, "created_at")
	_follow.DeletedAt = field.NewInt64(tableName, "deleted_at")
...
func (f *follow) updateTableName(table string) *follow {
	...
	f.FollowedID = field.NewInt64(table, "followed_id")
...
func (f *follow) fillFieldMap() {
	...
	f.fieldMap["followed_id"] = f.FollowedID
