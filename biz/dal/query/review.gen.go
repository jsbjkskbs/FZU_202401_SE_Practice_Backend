...
func newReview(db *gorm.DB, opts ...gen.DOOption) review {
	...
	_review.VideoID = field.NewInt64(tableName, "video_id")
	_review.ReviewerID = field.NewInt64(tableName, "reviewer_id")
	_review.SubmittedAt = field.NewInt64(tableName, "submitted_at")
	_review.ReviewedAt = field.NewInt64(tableName, "reviewed_at")
	_review.ReviewResult = field.NewString(tableName, "review_result")
...
type review struct {
	...
	ReviewerID   field.Int64  // 审核者ID
	SubmittedAt  field.Int64  // 提交时间
	ReviewedAt   field.Int64  // 审核时间
	ReviewResult field.String // 审核结果
...
func (r *review) updateTableName(table string) *review {
	...
	r.VideoID = field.NewInt64(table, "video_id")
	r.ReviewerID = field.NewInt64(table, "reviewer_id")
	r.SubmittedAt = field.NewInt64(table, "submitted_at")
	r.ReviewedAt = field.NewInt64(table, "reviewed_at")
	r.ReviewResult = field.NewString(table, "review_result")
