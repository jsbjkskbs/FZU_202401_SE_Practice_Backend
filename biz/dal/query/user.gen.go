...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.MfaEnable = field.NewBool(tableName, "mfa_enable")
...
type user struct {
	...
	Role      field.String // 权限
	AvatarURL field.String // 用户头像url
	CreatedAt field.Int64  // 创建账号时间
	UpdatedAt field.Int64  // 最近登录时间
	DeletedAt field.Int64  // 账号删除时间
	MfaSecret field.String // mfa秘钥
	MfaEnable field.Bool   // 是否使用mfa
...
func (u *user) updateTableName(table string) *user {
	...
	u.MfaEnable = field.NewBool(table, "mfa_enable")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["mfa_enable"] = u.MfaEnable
}
